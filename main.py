...
from services.persistence.exercise_repository import get_users_exercises, clear_workout_history
...
def main():
    ...
    with st.sidebar:
        st.title("🏋️‍♂️ Your Real-Time AI Fitness Coach")
    ...
    if st.button("Clear Workout History"):
